// Pour Vite et React, assure-toi que ce fichier a l'extension .js ou .ts
// et que "type": "module" est bien dans ton package.json (normal avec Vite).
// Si tu as ce message dans le navigateur, c'est que tu essaies d'inclure ce fichier
// dans un contexte non supporté (ex: balise <script src="..."> dans index.html).
// Il faut importer ce fichier UNIQUEMENT via des imports ESModules dans React.

// Ne rien changer ici si tu utilises bien import/export dans React/Vite.
// Si tu as mis ce fichier dans public/ ou tu l'appelles dans index.html, retire-le de là.
