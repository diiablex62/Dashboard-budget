 ...
 * @description Composant de tooltip pour afficher les détails des revenus
 */
        ...
        <div className='whitespace-pre-line'>
          <div>
            <div className='mb-2'>
              ...
              {formatMontant(totalRevenusCourant)}€
            </div>
            <ul className='mb-2'>
            ...
            <ul className='mb-2'>
              <li className='text-green-400'>
                <span className='font-bold'>Revenus :</span>{" "}
                {formatMontant(revenusClassiquesActuels)}€
              </li>
              <li className='text-blue-400'>
                Paiements récurrents : {formatMontant(revenusRecurrentsActuels)}
                €
              </li>
              <li className='text-purple-400'>
                Paiements échelonnés : {formatMontant(revenusEchelonnesActuels)}
                €
              </li>
            </ul>
            <div className='mb-2'>
              <span className='font-semibold'>Mois précédent :</span>{" "}
              {formatMontant(totalRevenusMoisPrec)}€
            </div>
            <ul>
              <li className='text-green-400'>
                <span className='font-bold'>Revenus :</span>{" "}
